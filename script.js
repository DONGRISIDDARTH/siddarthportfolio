    ...
    const state = {
      topSkills:["Machine Learning","Deep Learning","Data Science","Problem Solving"],
      skillsCode:["C","C++","JavaScript","Python","Java","SQL","Git","GitHub","VS Code","Jupyter","Google Colab","IBM Watson Studio"],
      skillsStack:["TensorFlow","Scikit‑Learn","Pandas","NumPy","Matplotlib","Streamlit","REST API","MySQL","MongoDB","REST APIs"],
      projects:[
        {
        ...
        },
        {
          ...
          links:[{label:"Source Code", href:"https://github.com/DONGRISIDDARTH/Machine-Learning-Project-Classification-of-Loan-Status-Using-ML-Algorithms-"}],
          tags:["Analysis","SVM","KNN","Decision Tree","Logistic Regression"]
        }
      ]
    };
